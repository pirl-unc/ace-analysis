...
if __name__ == "__main__":
    ...
    for index, row in df_experiments.iterrows():
        ...
        df_results.to_csv(
            '%s/deconvolution_methods_experiment_results_%i.tsv' % (output_dir, experiment_id),
            sep='\t',
            index=False
        )
        df_assignments.to_csv(
            '%s/deconvolution_methods_experiment_assignments_%i.tsv' % (output_dir, experiment_id),
            sep='\t',
            index=False
        )
