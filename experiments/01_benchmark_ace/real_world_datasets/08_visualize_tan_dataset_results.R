...
MERGED.TSV.FILE <- "/Users/leework/Documents/Research/projects/project_ace/data/processed/01_benchmark_ace/real_world_datasets/tan_et_al_inf_gen_evol_2021/tan2021_dataset_experiment_results_merged.tsv"
OUTPUT.DIR <- "/Users/leework/Documents/Research/projects/project_ace/data/processed/01_benchmark_ace/real_world_datasets/tan_et_al_inf_gen_evol_2021"
DODGE.WIDTH <- 0.5
...
plot.num.total.pools <- ggplot(df.plot, aes(x = solver, y = predicted_total_pools, fill = solver)) + 
  ...
  theme_pubr()
ggsave(plot = plot.num.total.pools, filename = paste0(OUTPUT.DIR, "/tan2021_total_pools.pdf"),
...
ggsave(plot = plot.precision, filename = paste0(OUTPUT.DIR, "/tan2021_precision.pdf"),
       width = 4, height = 8, dpi = 300)
