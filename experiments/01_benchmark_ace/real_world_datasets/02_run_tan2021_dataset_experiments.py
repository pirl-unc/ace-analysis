...
if __name__ == "__main__":
    ...
    df_results.to_csv(
        output_dir + '/tan_et_al_inf_gen_evol_2021_experiment_results_%i.tsv' % experiment_id,
        sep='\t',
        index=False
    )
    df_assignments.to_csv(
        output_dir + '/tan_et_al_inf_gen_evol_2021_experiment_assignments_%i.tsv' % experiment_id,
        sep='\t',
        index=False
    )
