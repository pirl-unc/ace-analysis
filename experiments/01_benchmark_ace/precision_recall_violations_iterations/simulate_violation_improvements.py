...
from golfy.initialization import init as golfy_init
from golfy.evaluation import evaluate_design, EvaluationResult
...
SIM_ITERS = 20
OPTIM_ITERS = 100
REFERENCE_PEPTIDES_CSV_FILE = '/Users/leework/Documents/Research/projects/project_ace/data/raw/iedb_mmer_val.csv'
OUTPUT_DIR = '/Users/leework/Documents/Research/projects/project_ace/data/processed/01_benchmark_ace/precision_recall_violations_iterations'
...
if __name__ == "__main__":
    ...
    df.to_csv(OUTPUT_DIR + '/precision_recall_f1_violations.csv', index=False)
