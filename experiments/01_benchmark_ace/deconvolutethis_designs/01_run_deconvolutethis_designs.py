...
DESIGNS_CSV_FILE = '/datastore/lbcfs/collaborations/pirl/members/jinseok/projects/project_ace/data/raw/deconvolutethis_designs.csv'
...
OUTPUT_DIR = '/datastore/lbcfs/collaborations/pirl/members/jinseok/projects/project_ace/data/processed/01_benchmark_ace/deconvolutethis_designs'
...
if __name__ == "__main__":
    ...
    print('Started running deconvolutethis design experiments')
    for index, row in df_experiments.iterrows():
        ...
        experiment = Experiment(
            ...
            peptide_sampling_method='levenshtein',
        ...
        df_results.to_csv(
            output_dir + '/deconvolutethis_design_experiment_results_%i.tsv' % experiment_id,
            sep='\t',
            index=False
        )
        df_assignments.to_csv(
            output_dir + '/deconvolutethis_design_experiment_assignments_%i.tsv' % experiment_id,
            sep='\t',
            index=False
        )
        print('Finished running the above experiment.')
    print('Finished running deconvolutethis design experiments')
