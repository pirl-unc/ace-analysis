...
OUTPUT_DIR = '/datastore/lbcfs/collaborations/pirl/members/jinseok/projects/project_ace/data/processed/03_benchmark_ace_runtime_and_memory'
ITERATIONS = 100
...
if __name__ == '__main__':
    ...
    df_benchmark.to_csv(OUTPUT_DIR + 'ace_runtime_memory_benchmark_experiment_results.csv', index=False)
