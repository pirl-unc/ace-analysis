...
OUTPUT_DIR = "/datastore/lbcfs/collaborations/pirl/members/jinseok/projects/project_ace/data/processed/04_real_world_datasets/cameron_2013/03_generated_configurations"
...
if __name__ == "__main__":
    ...
    for peptide_tsv_file in glob.glob('%s/*immunogenic_rep*.tsv' % (SAMPLED_PEPTIDES_DIR)):
        tasks.append((peptide_tsv_file, 36, 6, 3))
